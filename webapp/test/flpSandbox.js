		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#commhirjengdrawing-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commhirjengdrawing-display": {
								"semanticObject": "commhirjengdrawing",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.mhirj.engdrawing",
									"url": sap.ui.require.toUrl("com/mhirj/engdrawing")
								}
							}
						}
					}
